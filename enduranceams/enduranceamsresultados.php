...
<?php
 ...
 // $PDO3 = new PDO("mysql:host=mysql.hostinger.com.br;dbname=u240322781_teste;charset=utf8mb4", "u240322781_root", "chemical99");
...
$PDO3 = new PDO("mysql:host=localhost;dbname=gridonline;charset=utf8mb4", "root", ""); 
...
<!--             <li><a href="#">Regulamento</a></li>
        ...
        <div class="container-fluid bg-3 text-center"> 
          <hr>
          <div><h2>Racelan GT2/GTE Series - Calendário/Resultados</h2></div>   
          <hr>
        </div> 
        ...
        <?php
          $sql =  "SELECT nome,pista,imagemnome,imagemmapa,data,ordempista,idsessionrace,idsessionqualy
                    ...
                    where  pistatorneio.idtorneio=4
                    order by
                    ordempista";
...
<div class="container-fluid">
  <div class="row" align="center">
                ...
                { ?>  
                                ...
                                <div class="col-sm-4">    
                                  <br>
                                    <img <?php echo "src=../img/tracks/".$row['imagemmapa'].".png";?> >                          
                                  

                                    <img id="testefundo" width="256" <?php echo "src=../img/tracks/".$row['imagemnome'].".png";?> >
                                ...
                                <!-- Modal Race-->
                                <div class="modal fade" <?php echo "id=".$row['idsessionrace'];?> role="dialog">

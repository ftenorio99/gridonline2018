...
<script type="text/javascript">
    ...
    document.getElementById("imgskin").src = "../img/enduranceac/skin/"+selskin+"/preview.jpg";
    }       
</script>
        ...
        <nav class="navbar navbar-inverse" >
          <div class="container-fluid">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="supertrofeo.php"> <img src="../img/enduranceac/racelan.png" width="60" height="30" alt=""/> </a>
            </div>
